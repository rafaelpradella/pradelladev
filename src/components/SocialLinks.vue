<template>
    <ul>
        <li>
            <a @click="gaEvent('Home','Social-Link', 'Github')" class="u-github" href="https://github.com/rafaelpradella" title="My GitHub profile" target="_blank" rel="noopener">
                <Icons id="github" :is-presentation="false" />
            </a>
        </li>
        <li>
            <a @click="gaEvent('Home','Social-Link', 'CodeSandbox')" class="u-codesandbox" href="https://codesandbox.io/u/rafaelpradella" title="My CodeSa profilendbox" target="_blank" rel="noopener">
                <Icons id="codesandbox" :is-presentation="false" />
            </a>
        </li>
        <li>
            <a @click="gaEvent('Home','Social-Link', 'LinkedIn')" class="u-linkedin" href="https://www.linkedin.com/in/rafael-pradella-14745142/" title="My Linked profileIn" target="_blank" rel="noopener">
